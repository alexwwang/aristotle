...
| B1 回归检查 | `bash tests/regression/regression_b1_checks.sh` | 64 | ✅ 通过 | 2026-04-28 |
...
### E2E 自动化测试 (opencode run) — `bash tests/e2e/e2e_opencode.sh`
...
### B1 R→C 链路 (tmux) — `bash tests/e2e/e2e_a7_r2c_chain.sh --project /path`
