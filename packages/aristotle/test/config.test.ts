...
describe('config', () => {
  ...
  // ── AC-01: resolveConfig() — config file reads correctly ─────────────────
  ...
  // ── AC-02: resolveConfig() — env var override (no config file) ───────────
  ...
  // ── AC-03: resolveConfig() — config file takes priority over env vars ────
  ...
  // ── AC-04: resolveConfig() — auto-detection fallback (no config, no env) ─
  ...
  // ── AC-05: detectMcpDir — walk up and find pyproject.toml ────────────────
  ...
  // ── AC-06: detectMcpDir — sibling check ──────────────────────────────────
  ...
  // ── AC-07: detectMcpDir — ARISTOTLE_PROJECT_DIR fallback ─────────────────
  ...
  // ── AC-08: detectMcpDir — default fallback ───────────────────────────────
  ...
  // ── AC-10: resolveConfig() — corrupted config file ───────────────────────
  ...
  // ── AC-11: resolveConfig() — readFileSync throws ─────────────────────────
  ...
  // ── AC-12: resolveConfig() — ARISTOTLE_CONFIG env var override ───────────
  ...
  // ── AC-13: ARISTOTLE_CONFIG pointing to nonexistent file ─────────────────
  ...
  // ── AC-14: partial config file — only mcp_dir set ────────────────────────
  ...
  // ── AC-15: clearConfigCache as arrow function — independent call ─────────

  it('should call clearConfigCache independently without this binding', () => {
    const fn = clearConfigCache;
