...
> **Version**: v1.3 (MVP)
> **Status**: Draft - Ralph Loop Round 1 Review
...
在同一 stage boundary，V-8/V-9/V-12 可能同时触发。合并策略：
...
|---|-------------------|-----------------|-----------------|
| FP-1 | Stop conditions | stop condition, gate pass, 2 consecutive rounds | 停止条件, 连续2轮, 连续两轮, 达标 |
